...
for runtodo in dirneed:
        ...
        if usepep==1:
                ...
                halosA = read_halo_history(rundir, snumadd=snumadd,suffixadd=suffixadd, halonostr=halostr, maindir=maindir, hubble=hubble, comoving=0,reverse=reverse)
...
#       print 't = '+str(t_now)+' Gyr'
        plt.savefig(plotloc+'/figures/Mencgsdm_'+runtodo+'_'+str(Nsnap)+'.pdf')
        plt.clf()
        ...
        print 't = '+str(t_now)+' Gyr'
        plt.savefig(plotloc+'/figures/rhogsdm_'+runtodo+'_'+str(Nsnap)+'.pdf')
        plt.clf()
