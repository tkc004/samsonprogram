...
def avedencosmotestinput(subdict):
        ...
        if wanted=='gmr' or wanted=='crer' or wanted=='avedenr' or wanted=='avecrdenr'\
        ...
        or wanted=='avekedenr':
            ...
            for runtodo in dirneed:
                ...
                if haveB>0:
                    lsn='dashed'
                if havecr==0 and (wanted=='avecrdenr' or wanted=='crer'):
                    continue
                if cosmo==1:
                    h0=1
                    rotface=1
                    ...
                    rotface=0
                    datasup=1;
                G = readsnapwcen(the_snapdir, Nsnapstring, 0, snapshot_name=the_prefix, extension=the_suffix, havecr=havecr,cosmo=cosmo,h0=cosmo,usepep=usepep,maindir=maindir,rundir=rundir,halostr=halostr)
                Gp = G['p']
                Gv = G['v']
                Gu = G['u']
                Gm = G['m']
                ...
                if wanted == 'gmr':
                    plt.plot(radl, Gm_in_sunl, label=labelneed,color=color,ls=lsn,lw=2)
                if wanted == 'crer':
                    plt.plot(radl, crel, label=labelneed,color=color,ls=lsn,lw=2)
                if wanted == 'avedenr':
