...
import collections
from calgravprefrompar import calgravprefrompar


keystore=['plot1','plot2','plot3','plot4','plot5','plot6']

def rhogzdispartestinput(subdict):
    ...
    for (index, key) in enulist:
        ...
        for j, runtodo in enumerate(items):
            ...
            plotdict = calgravprefrompar(ssdict)
        ...
        PS.miscsetup(ax,logx=0,logy=1,xlab=xlab,ylab=ylab,legendneed=legendneed,\
