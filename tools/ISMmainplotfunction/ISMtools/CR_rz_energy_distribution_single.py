...
def CR_rz_energy_distribution_single(ssdict):
    ...
    or wanted=='crdpz' or wanted=='crdpzcox' or wanted=='crpzcox':
        for isnap in range(startno,Nsnap+1,snapsep):
            ...
            egydata=CRTF.energyoutput(runtodo,isnap,
                                 ...
                                 cylrin=withoutr,cylz=maxlength,nbin = 7)   
        ...
        if wanted=='crdenr' or wanted=='crdenz':
            if egyneed=='etur':
                plotdict[wanted]['ylab'] = r'$e_{\rm tur}\;[{\rm erg/cm^3}]$'
            if egyneed=='ecr':
                plotdict[wanted]['ylab'] = r'$e_{\rm cr}\;[{\rm erg/cm^3}]$'
            if egyneed=='eth':
                plotdict[wanted]['ylab'] = r'$e_{\rm th}\;[{\rm erg/cm^3}]$'
            if egyneed=='eB':
                plotdict[wanted]['ylab'] = r'$e_{\rm B}\;[{\rm erg/cm^3}]$'
        elif wanted=='crpr' or wanted=='crpz' or wanted=='crpzcox':
            if egyneed=='etur':
                plotdict[wanted]['ylab'] = r'$P_{\rm tur}\;[{\rm dyne/cm^2}]$'
            if egyneed=='ecr':
                plotdict[wanted]['ylab'] = r'$P_{\rm cr}\;[{\rm dyne/cm^2}]$'
            if egyneed=='eth':
                plotdict[wanted]['ylab'] = r'$P_{\rm th}\;[{\rm dyne/cm^2}]$'
            if egyneed=='eB':
                plotdict[wanted]['ylab'] = r'$P_{\rm B}\;[{\rm dyne/cm^2}]$'
        elif wanted=='crvr':
        ...
        if runlabel=='m12fres7000':
            plotdict[wanted]['lsn'] = 'dashed'
        elif runlabel=='m12mres7000':
            plotdict[wanted]['lsn'] = 'dotted'
        print 'lsn', plotdict[wanted]['lsn']
        plotdict[wanted]['linelab'] = runlabel
        plotdict[wanted]['marker'] = 'None'
        plotdict[wanted]['runtodo'] = runtodo
        plotdict[wanted]['labelneed'] = labelneed
        print 'linelab', plotdict[wanted]['linelab']
        print 'labelneed', plotdict[wanted]['labelneed']
        plotdict[wanted]['color'] = color
        plotdict[wanted]['runtitle'] = runtitle
        plotdict[wanted]['ptitle'] = ptitle
        if wanted=='crdenz':
            filename=plotloc+'CRplot/crdenz/CRz_single_'+egyneed+'_'+fmeat+'_sn'+str(startno)+'_'+str(Nsnap)+'.pdf'
        elif wanted=='crpz':
            filename=plotloc+'CRplot/crdenz/CRpz_single_'+egyneed+'_'+fmeat+'_sn'+str(startno)+'_'+str(Nsnap)+'.pdf'        
        elif wanted=='crdenr':
            filename=plotloc+'CRplot/crdenr/CRr_single_'+egyneed+'_'+fmeat+'_sn'+str(startno)+'_'+str(Nsnap)+'.pdf'
        elif wanted=='crpr':
            filename=plotloc+'CRplot/crdenr/CRpr_single_'+egyneed+'_'+fmeat+'_sn'+str(startno)+'_'+str(Nsnap)+'.pdf'
        elif wanted=='crvr':
            filename=plotloc+'CRplot/crdenr/CRvr_single_'+egyneed+'_'+fmeat+'_sn'+str(startno)+'_'+str(Nsnap)+'.pdf'
        elif wanted=='crdpz':
            filename=plotloc+'CRplot/crdenz/CRdpz_single_'+egyneed+'_'+fmeat+'_sn'+str(startno)+'_'+str(Nsnap)+'.pdf'
        elif wanted=='crpzcox':
            filename=plotloc+'CRplot/crpzcox/CRpzcox_single_'+egyneed+'_'+fmeat+'_sn'+str(startno)+'_'+str(Nsnap)+'.pdf'
        elif wanted=='crdpzcox':
            filename=plotloc+'CRplot/crdenz/CRdpzcox_single_'+egyneed+'_'+fmeat+'_sn'+str(startno)+'_'+str(Nsnap)+'.pdf'
